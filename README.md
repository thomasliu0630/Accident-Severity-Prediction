With millions of traffic accidents across the U.S., we analyzed key factors contributing to accident severity using the US Countrywide Traffic Accident Dataset from Kaggle. Our approach includes: 
